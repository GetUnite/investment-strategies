...
import { ICvxBooster, IERC20, IVoteExecutor, UniversalCurveConvexStrategy, Unwinder } from "../typechain"
...
describe("Unwinder", async () => {
    ...
    before(async () => {
        ...
        strategy = await ethers.getContractAt("UniversalCurveConvexStrategy", "0xa248Ba96d72005114e6C941f299D315757877c0e");
