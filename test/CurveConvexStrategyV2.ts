...
import { CurveConvexStrategyV2, ICvxBooster, IERC20Metadata, IExchange, IWrappedEther } from "../typechain";
...
describe("CurveConvexStrategyV2", function () {
    let strategy: CurveConvexStrategyV2;
